...
export const coreDict: Dict = {
  ...
  "importance.standard": { zh: "无标签", en: "No label" },
  "importance.peripheral": { zh: "无标签", en: "No label" },
  "importance.none": { zh: "无标签", en: "No label" },
  "importance.label": { zh: "重要性", en: "Importance" },
  "importance.auto": { zh: "自动推导", en: "Auto (derived)" },
  "importance.autoHint": {
    zh: "自动：领导职务或高职级视为核心，其余不显示重要性标签",
    en: "Auto: leadership or senior level counts as core; everyone else gets no importance label",
  },
