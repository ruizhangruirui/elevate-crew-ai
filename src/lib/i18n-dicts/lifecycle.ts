...
export const lifecycleDict: Dict = {
  ...
  "lc.flow.byMonth": { zh: "按月分布", en: "By month" },
  "lc.flow.range": { zh: "时间范围", en: "Range" },
  "lc.flow.monthsUnit": { zh: "个月", en: "mo" },
  "lc.flow.rangeLabelPrefix": { zh: "近", en: "Last" },
  ...
  "lc.flow.recent": { zh: "最近人员变动", en: "Recent people changes" },

  "lc.analysis.title": { zh: "数据分析", en: "Analysis" },
  "lc.analysis.suggestTitle": { zh: "建议", en: "Recommendations" },
  "lc.analysis.noExits": {
    zh: "所选时间范围内没有离职记录。",
    en: "No exits recorded in the selected range.",
  },
  "lc.analysis.turnoverPrefix": { zh: "该区间离职人数占当前在岗", en: "Exits equal" },
  "lc.analysis.turnoverSuffix": { zh: "。", en: "of current headcount." },
  "lc.analysis.topPrefix": { zh: "最主要原因是「", en: 'The leading reason is "' },
  "lc.analysis.topMid": { zh: "」，占比 ", en: '", accounting for ' },
  "lc.analysis.topSuffix": { zh: "。", en: " of all exits." },
  "lc.analysis.voluntaryHigh": {
    zh: "主动离职占比过半，通常指向发展空间、薪酬或直属主管关系问题。",
    en: "Over half of exits are voluntary, which usually points to growth, pay, or manager-relationship issues.",
  },
  "lc.analysis.involuntaryHigh": {
    zh: "被动离场（辞退 / 合同或实习到期）占比过半，更可能是招聘匹配度或用工结构问题。",
    en: "Most exits are involuntary (termination, contract or internship end), pointing to hiring fit or workforce structure.",
  },
  "lc.analysis.netNegative": {
    zh: "近 90 天净增为负，团队规模在收缩，注意关键岗位是否被掏空。",
    en: "Net headcount over the last 90 days is negative; check whether critical roles are being drained.",
  },
  "lc.analysis.suggestVoluntary": {
    zh: "对主动离职做离职面谈并归类动因，重点复核同一团队是否重复出现。",
    en: "Run exit interviews for voluntary leavers and tag root causes; watch for repeats in the same team.",
  },
  "lc.analysis.suggestTermination": {
    zh: "复盘辞退案例的招聘环节与试用期评估标准，减少错配。",
    en: "Review hiring screens and probation criteria behind terminations to reduce mis-hires.",
  },
  "lc.analysis.suggestInternship": {
    zh: "实习到期属于正常流出，可建立转正评估清单，提前锁定优秀实习生。",
    en: "Internship ends are normal churn; add a conversion checklist to lock in strong interns early.",
  },
  "lc.analysis.suggestContract": {
    zh: "合同到期集中出现时，提前 2 个月启动续签或替补招聘。",
    en: "When contract ends cluster, start renewal or backfill hiring two months ahead.",
  },
  "lc.analysis.suggestNet": {
    zh: "净增为负：优先补齐关键岗位空缺，并为单点承载能力指定第二承载人。",
    en: "Negative net: prioritise filling critical vacancies and assign backups for single-carrier capabilities.",
  },
